...
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<Long, PaymentKafkaDto> producerFactory() {
        return new DefaultKafkaProducerFactory<>(producerConfigs());
    }

    @Bean
    public KafkaTemplate<Long, PaymentKafkaDto> kafkaTemplate() {
        KafkaTemplate<Long, PaymentKafkaDto> template = new KafkaTemplate<>(producerFactory());
    ...
    @Bean
    public ConsumerFactory<Long, ErrorKafkaDto> errorConsumerFactory() {
        return new DefaultKafkaConsumerFactory<>(
                consumerConfigs(),
                new LongDeserializer(),
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<Long, ErrorKafkaDto> errorKafkaListenerContainerFactory() {
